        ...
        <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
            <div className="mt-10 lg:w-1/2">
                <h1 className="font-roboto text-3xl text-center font-bold text-dark-soft md:text-5xl lg:text-4xl xl:text-5xl lg:text-left lg:max-w-[540px]">
                    Read the most intersecting Articles
                </h1>
                <p className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsum
                    tenetur reiciendis incidunt reprehenderit labore.
                </p>
                <form onSubmit={submitSearchKeywordHandler} className="flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative">
                    ...
                    <button type="submit" className="w-full bg-primary text-white font-semibold rounded-lg px-5 py-3 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2">Search</button>
                </form>
                <div className="flex mt-4 flex-col lg:flex-row lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7">
                    ...
                    <ul className="flex flex-wrap gap-x-2.5 gap-y-2.5 mt-3 lg:text-sm xl:text-base">
                        ...
                        <li className="rounded-lg bg-primary bg-opacity-10 px-3 py-1.5 text-primary font-semibold">userExperience</li>
